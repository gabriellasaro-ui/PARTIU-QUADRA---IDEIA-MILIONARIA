...
def agenda_semana(offset=0):
    """Grade semanal (estilo Google Calendar) com eventos posicionados.
    offset move a semana exibida: -1 = passada, +1 = próxima."""
    ...
    # eventos mock: (dia_idx, hora_inicio, duracao_horas, cliente, status_cls)
    raw = [
...
def gerente_dados():
    """Métricas + dados do dashboard do gerente."""
    ...
    # amostra ao vivo (reflete aprovacoes) para a tabela "Próximas reservas"
    rsv = store.reservas()
