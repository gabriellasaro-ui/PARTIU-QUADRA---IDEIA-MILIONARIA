...
/* WS autenticado: /ws?token=<access_token>. Sem API ou sem sessao, fica
   inerte. Eventos chegam como `pq:ws:event` no window; quem quiser escutar
   `booking.updated` / `message.new` ouve esse evento. Reconnect com backoff
